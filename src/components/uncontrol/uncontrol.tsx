  ...
  return (
    <>
      ...
      <form onSubmit={onSubmit}>
        ...
        <label>Email</label>
          <input ref={emailUncontrol} placeholder="Email" type="email" name="email" />
          {/* {errors.email ? (<p className="error__message">{errors.email.message}</p>) : <p></p>} */}

        <label>Password</label>
          <input ref={password1Uncontrol} placeholder="Password1" type="password" name="password1" />
          {/* {errors.password1 ? (<p className="error__message">{errors.password1.message}</p>) : <p></p>} */}

        <label>Password</label>
          <input ref={password2Uncontrol} placeholder="Password2" type="password" name="password2" />
          {/* {errors.password2 ? (<p className="error__message">{errors.password2.message}</p>) : <p></p>} */}

        <label>Gender</label>
        <select>
            <option value="">Select Gender</option>
            <option ref={genderUncontrol} value="male">Male</option>
            <option ref={genderUncontrol} value="female">Female</option>
        </select>
        ...
        <label>Country</label>
        <input ref={countryUncontrol} placeholder="Country" type="text" name="country" />
